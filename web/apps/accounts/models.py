...
class AnalysisHistory(models.Model):
    """History of stock analysis performed by user."""
    ...
    signal = models.IntegerField(choices=SIGNAL_CHOICES, verbose_name="신호")
    ...
    def __str__(self):
        return f"{self.user.username} - {self.symbol} ({self.indicator}) - {self.created_at}"
